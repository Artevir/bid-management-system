...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  return withAuth(req, async (_request, userId) => {
    try {
      ...
      if (body.smsReminderEnabled !== undefined)
        updateData.smsReminderEnabled = body.smsReminderEnabled;
      ...
      if (body.biddingRequirements !== undefined)
        updateData.biddingRequirements = body.biddingRequirements;
      if (body.partnerCompanyId !== undefined) updateData.partnerCompanyId = body.partnerCompanyId;
      if (body.partnerCompanyName !== undefined)
        updateData.partnerCompanyName = body.partnerCompanyName;
      if (body.partnerContactPerson !== undefined)
        updateData.partnerContactPerson = body.partnerContactPerson;
      if (body.partnerContactPhone !== undefined)
        updateData.partnerContactPhone = body.partnerContactPhone;
      if (body.legalRepName !== undefined) updateData.legalRepName = body.legalRepName;
      if (body.legalRepIdCardProvided !== undefined)
        updateData.legalRepIdCardProvided = body.legalRepIdCardProvided;
      if (body.legalRepIdCardType !== undefined)
        updateData.legalRepIdCardType = body.legalRepIdCardType;
      if (body.bidAgentName !== undefined) updateData.bidAgentName = body.bidAgentName;
      if (body.bidAgentIdCardProvided !== undefined)
        updateData.bidAgentIdCardProvided = body.bidAgentIdCardProvided;
      if (body.bidAgentIdCardType !== undefined)
        updateData.bidAgentIdCardType = body.bidAgentIdCardType;
      ...
      if (body.partnerLiaisonName !== undefined)
        updateData.partnerLiaisonName = body.partnerLiaisonName;
      if (body.partnerLiaisonPhone !== undefined)
        updateData.partnerLiaisonPhone = body.partnerLiaisonPhone;
      if (body.partnerLiaisonWechat !== undefined)
        updateData.partnerLiaisonWechat = body.partnerLiaisonWechat;
      if (body.partnerConfirmStatus !== undefined)
        updateData.partnerConfirmStatus = body.partnerConfirmStatus;
      if (body.partnerConfirmedAt !== undefined) {
        updateData.partnerConfirmedAt = body.partnerConfirmedAt
          ? new Date(body.partnerConfirmedAt)
          : null;
      }
      if (body.materialReceiverName !== undefined)
        updateData.materialReceiverName = body.materialReceiverName;
      if (body.materialReceiverPhone !== undefined)
        updateData.materialReceiverPhone = body.materialReceiverPhone;
      if (body.electronicReceiveAddress !== undefined)
        updateData.electronicReceiveAddress = body.electronicReceiveAddress;
      if (body.paperReceiveAddress !== undefined)
        updateData.paperReceiveAddress = body.paperReceiveAddress;
      if (body.materialAcceptanceStatus !== undefined)
        updateData.materialAcceptanceStatus = body.materialAcceptanceStatus;
      if (body.materialAcceptanceNotes !== undefined)
        updateData.materialAcceptanceNotes = body.materialAcceptanceNotes;
      if (body.applicationSummary !== undefined)
        updateData.applicationSummary = body.applicationSummary;
