...
import { db } from '@/db';
import { moneyTerms } from '@/db/schema';

// 040: GET /api/tender-center/projects/{projectId}/versions/{versionId}/money-terms
export async function GET(
  ...
  return withAuth(request, async (_req, userId) => {
    ...
    const data = await db.query.moneyTerms.findMany({
      where: and(
