...
export async function GET(req: NextRequest) {
  try {
    ...
    // 常规查询
    const filters = {
      sourceId: searchParams.get('sourceId') ? parseInt(searchParams.get('sourceId')!) : undefined,
      status: searchParams.get('status') || undefined,
      projectId: searchParams.get('projectId') ? parseInt(searchParams.get('projectId')!) : undefined,
      industry: searchParams.get('industry') || undefined,
      region: searchParams.get('region') || undefined,
      keyword: searchParams.get('keyword') || undefined,
      followedBy: searchParams.get('followedBy') ? parseInt(searchParams.get('followedBy')!) : undefined,
      publishDateFrom: searchParams.get('publishDateFrom') ? new Date(searchParams.get('publishDateFrom')!) : undefined,
      publishDateTo: searchParams.get('publishDateTo') ? new Date(searchParams.get('publishDateTo')!) : undefined,
      submissionDeadlineFrom: searchParams.get('submissionDeadlineFrom') ? new Date(searchParams.get('submissionDeadlineFrom')!) : undefined,
