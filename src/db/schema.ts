...
export const permissions = pgTable(
  ...
  (table) => {
    return {
      ...
      resourceActionIdx: uniqueIndex('permissions_resource_action_idx').on(
        table.resource,
        table.action
      ),
    };
...
export const projects = pgTable('projects', {
  ...
  ownerId: integer('owner_id')
    .notNull()
    .references(() => users.id), // 项目负责人
  departmentId: integer('department_id')
    .notNull()
    .references(() => departments.id), // 所属部门
  description: text('description'),
...
export const projectFiles = pgTable(
  ...
  (table) => {
    return {
      projectFileIdx: uniqueIndex('project_files_project_file_idx').on(
        table.projectId,
        table.fileId
      ),
    };
...
export const projectTagRelations = pgTable(
  ...
  (table) => {
    return {
      projectTagIdx: uniqueIndex('project_tag_relations_project_tag_idx').on(
        table.projectId,
        table.tagId
      ),
    };
...
export const parseResults = pgTable(
  ...
  (table) => {
    return {
      taskSectionIdx: uniqueIndex('parse_results_task_section_idx').on(
        table.taskId,
        table.pageNumber,
        table.sectionTitle
      ),
...
export const responseMatrices = pgTable(
  'response_matrices',
  {
    id: serial('id').primaryKey(),
    projectId: integer('project_id')
  ...
  (table) => {
    return {
      projectMatrixIdx: uniqueIndex('response_matrices_project_name_idx').on(
        table.projectId,
        table.name
      ),
    };
...
export const responseItems = pgTable('response_items', {
  ...
  matrixId: integer('matrix_id')
    .notNull()
    .references(() => responseMatrices.id, { onDelete: 'cascade' }),
...
export const knowledgeApprovalSteps = pgTable(
  'knowledge_approval_steps',
  {
    id: serial('id').primaryKey(),
    requestId: integer('request_id')
      .notNull()
      .references(() => knowledgeApprovalRequests.id, { onDelete: 'cascade' }),
  ...
  (table) => {
    return {
      requestStepIdx: uniqueIndex('knowledge_approval_steps_request_step_idx').on(
        table.requestId,
        table.stepOrder
      ),
    };
...
export const knowledgeVersions = pgTable(
  ...
  (table) => {
    return {
      itemVersionIdx: uniqueIndex('knowledge_versions_item_version_idx').on(
        table.itemId,
        table.version
      ),
    };
...
export const bidChapters = pgTable(
  'bid_chapters',
  {
    id: serial('id').primaryKey(),
  ...
  (table) => {
    return {
      documentParentIdx: uniqueIndex('bid_chapters_document_parent_idx').on(
        table.documentId,
        table.parentId,
        table.sortOrder
      ),
...
export const approvalFlows = pgTable(
  ...
  (table) => {
    return {
      documentLevelIdx: uniqueIndex('approval_flows_document_level_idx').on(
        table.documentId,
        table.level
      ),
    };
...
// 提示词参数表
export const promptParameters = pgTable(
  'prompt_parameters',
  {
    id: serial('id').primaryKey(),
  ...
  (table) => {
    return {
      templateParamIdx: uniqueIndex('prompt_parameters_template_param_idx').on(
        table.templateId,
        table.name
      ),
    };
...
export const promptVersions = pgTable(
  ...
  (table) => {
    return {
      templateVersionIdx: uniqueIndex('prompt_versions_template_version_idx').on(
        table.templateId,
        table.version
      ),
    };
...
// 角色模板映射表
export const promptRoleMappings = pgTable(
  'prompt_role_mappings',
  {
    id: serial('id').primaryKey(),
    templateId: integer('template_id')
      .notNull()
  ...
  (table) => {
    return {
      templateRoleIdx: uniqueIndex('prompt_role_mappings_template_role_idx').on(
        table.templateId,
        table.roleId
      ),
    };
...
export const aiGenerationLogs = pgTable('ai_generation_logs', {
  ...
  chapterId: integer('chapter_id')
    .notNull()
    .references(() => bidChapters.id, { onDelete: 'cascade' }),
...
export const aiTestCases = pgTable(
  ...
  {
    id: serial('id').primaryKey(),
    evaluationSetId: integer('evaluation_set_id')
      .notNull()
      .references(() => aiEvaluationSets.id, { onDelete: 'cascade' }),
...
export const aiTestCaseResults = pgTable(
  'ai_test_case_results',
  {
    id: serial('id').primaryKey(),
    ...
    testCaseId: integer('test_case_id')
      .notNull()
      .references(() => aiTestCases.id, { onDelete: 'cascade' }),
  ...
  (table) => {
    return {
      testRunCaseIdx: uniqueIndex('ai_test_case_results_run_case_idx').on(
        table.testRunId,
        table.caseCode
      ),
    };
...
export const aiQualityMetrics = pgTable(
  'ai_quality_metrics',
  {
    id: serial('id').primaryKey(),
  ...
  (table) => {
    return {
      modelMetricIdx: uniqueIndex('ai_quality_metrics_model_metric_idx').on(
        table.modelId,
        table.category,
        table.metricName
      ),
...
// 文档生成历史关系
export const documentGenerationHistoriesRelations = relations(
...
export const unifiedTags = pgTable(
  'unified_tags',
  {
    id: serial('id').primaryKey(),
    name: varchar('name', { length: 100 }).notNull(),
...
export const entityTags = pgTable(
  'entity_tags',
  {
    ...
    tagId: integer('tag_id')
      .notNull()
      .references(() => unifiedTags.id, { onDelete: 'cascade' }),
  ...
  (table) => {
    return {
      entityTagIdx: uniqueIndex('entity_tags_entity_tag_idx').on(
        table.entityType,
        table.entityId,
        table.tagId
      ),
...
export const chapterTemplateCategoriesRelations = relations(
  chapterTemplateCategories,
  ({ one, many }) => ({
    creator: one(users, {
...
export const docFrameworkChapters = pgTable('doc_framework_chapters', {
  ...
  frameworkId: integer('framework_id')
    .notNull()
    .references(() => docFrameworks.id, { onDelete: 'cascade' }),
...
export const docFrameworkInstances = pgTable('doc_framework_instances', {
  ...
  bidDocumentId: integer('bid_document_id').references(() => bidDocuments.id, {
    onDelete: 'cascade',
  }),
...
// 文档框架章节内容表
export const docFrameworkContents = pgTable(
  'doc_framework_contents',
  {
    id: serial('id').primaryKey(),
    instanceId: integer('instance_id')
      .notNull()
      .references(() => docFrameworkInstances.id, { onDelete: 'cascade' }),
    chapterId: integer('chapter_id')
      .notNull()
      .references(() => docFrameworkChapters.id, { onDelete: 'cascade' }),
  ...
  (table) => ({
    instanceChapterUnique: uniqueIndex('instance_chapter_unique').on(
      table.instanceId,
      table.chapterId
    ),
  })
...
export const recentVisits = pgTable(
  ...
  (table) => {
    return {
      userEntityIdx: uniqueIndex('recent_visits_user_entity_idx').on(
        table.userId,
        table.entityType,
        table.entityId
      ),
      userLastVisitedIdx: uniqueIndex('recent_visits_user_last_visited_idx').on(
        table.userId,
        table.lastVisitedAt
      ),
    };
...
export const savedFilters = pgTable(
  ...
  (table) => {
    return {
      userEntityTypeIdx: uniqueIndex('saved_filters_user_entity_type_idx').on(
        table.userId,
        table.entityType
      ),
    };
...
export const favorites = pgTable(
  ...
  (table) => {
    return {
      userEntityIdx: uniqueIndex('favorites_user_entity_idx').on(
        table.userId,
        table.entityType,
        table.entityId
      ),
...
export const operationLogs = pgTable(
  ...
  (table) => {
    return {
      ...
      entityTypeIdx: uniqueIndex('operation_logs_entity_type_idx').on(
        table.entityType,
        table.entityId
      ),
    };
...
export const companyContactRoles = pgTable(
...
// 购买招标文件安排表
export const bidDocumentPurchases = pgTable(
  'bid_document_purchases',
  {
    id: serial('id').primaryKey(),
...
// 打印标书安排表
export const bidPrintings = pgTable(
  'bid_printings',
  {
    id: serial('id').primaryKey(),
...
export const bidArchiveDocuments = pgTable('bid_archive_documents', {
  ...
  archiveId: integer('archive_id')
    .notNull()
    .references(() => bidArchives.id, { onDelete: 'cascade' }),
...
export const companyFileReminders = pgTable('company_file_reminders', {
  ...
  companyId: integer('company_id')
    .notNull()
    .references(() => companies.id, { onDelete: 'cascade' }),
  companyFileId: integer('company_file_id')
    .notNull()
    .references(() => companyFiles.id, { onDelete: 'cascade' }),
...
// 公司文档框架主表
export const companyDocumentFrameworks = pgTable(
  'company_document_frameworks',
  {
    id: serial('id').primaryKey(),
...
// 公司框架章节表（支持多级标题）
export const companyFrameworkChapters = pgTable(
  'company_framework_chapters',
  {
    id: serial('id').primaryKey(),
    ...
    frameworkId: integer('framework_id')
      .notNull()
      .references(() => companyDocumentFrameworks.id, { onDelete: 'cascade' }),
...
// 公司文档框架关系
export const companyDocumentFrameworksRelations = relations(
...
export const companyFrameworkChaptersRelations = relations(
...
// 文件类型枚举
export const documentExtEnum = pgEnum('document_ext', ['pdf', 'doc', 'docx', 'xls', 'xlsx']);
...
export const bidDocumentInterpretations = pgTable(
  'bid_document_interpretations',
  {
    id: serial('id').primaryKey(),
    ...
    technicalSpecs: text('technical_specs'), // 技术规格（JSON）
    scoringItems: text('scoring_items'), // 评分细则（JSON）
...
export const bidTechnicalSpecs = pgTable(
  'bid_technical_specs',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
      .notNull()
      .references(() => bidDocumentInterpretations.id, { onDelete: 'cascade' }),
...
export const bidScoringItems = pgTable(
  'bid_scoring_items',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
...
export const bidRequirementChecklist = pgTable(
  'bid_requirement_checklist',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
      .notNull()
...
export const bidDocumentFramework = pgTable(
  'bid_document_framework',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
      .notNull()
...
export const bidInterpretationLogs = pgTable(
  'bid_interpretation_logs',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
      .notNull()
...
export const bidTimeReminders = pgTable(
  'bid_time_reminders',
  {
    id: serial('id').primaryKey(),
    interpretationId: integer('interpretation_id')
...
export const bidDocumentInterpretationsRelations = relations(
...
// 删除提醒记录表
export const deletionReminders = pgTable(
  'deletion_reminders',
  {
    id: serial('id').primaryKey(),

    recycleBinId: integer('recycle_bin_id')
      .notNull()
      .references(() => recycleBin.id, { onDelete: 'cascade' }),
    ...
    // 接收人
    notifyUserId: integer('notify_user_id')
      .notNull()
      .references(() => users.id),
...
// 工作流任务操作记录表
export const workflowTaskActions = pgTable(
...
export const projectOrgs = pgTable(
  'project_orgs',
  {
    id: serial('id').primaryKey(),
    projectId: integer('project_id')
...
export const projectPositions = pgTable(
  'project_positions',
  {
    id: serial('id').primaryKey(),
    orgId: integer('org_id')
      .notNull()
      .references(() => projectOrgs.id, { onDelete: 'cascade' }),
    name: varchar('name', { length: 50 }).notNull(),
...
export const projectOrgMembers = pgTable(
  'project_org_members',
  {
    id: serial('id').primaryKey(),
    orgId: integer('org_id')
      .notNull()
      .references(() => projectOrgs.id, { onDelete: 'cascade' }),
    positionId: integer('position_id').references(() => projectPositions.id, {
      onDelete: 'set null',
    }),
    userId: integer('user_id').references(() => users.id, { onDelete: 'cascade' }),
...
export const archivedOrgTemplates = pgTable(
  'archived_org_templates',
  {
    id: serial('id').primaryKey(),
    projectId: integer('project_id')
      .notNull()
...
export const projectDiscussions = pgTable(
  'project_discussions',
  {
    id: serial('id').primaryKey(),
    projectId: integer('project_id')
...
export const discussionFiles = pgTable(
  'discussion_files',
  {
    id: serial('id').primaryKey(),
    discussionId: integer('discussion_id')
      .notNull()
      .references(() => projectDiscussions.id, { onDelete: 'cascade' }),
    messageId: integer('message_id').references(() => discussionMessages.id, {
      onDelete: 'set null',
    }),
    fileId: integer('file_id').references(() => files.id, { onDelete: 'set null' }),
...
export const bidGuarantees = pgTable(
  'bid_guarantees',
  {
    id: serial('id').primaryKey(),
    projectId: integer('project_id')
...
export const authorizationApplications = pgTable(
...
export const authorizationManufacturers = pgTable(
  'authorization_manufacturers',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
      .notNull()
      .references(() => authorizationApplications.id, { onDelete: 'cascade' }),
  ...
  (table) => ({
    applicationIdx: uniqueIndex('authorization_manufacturers_application_idx').on(
      table.applicationId
    ),
  })
);
...
export const authorizationQualifications = pgTable(
  'authorization_qualifications',
  {
    id: serial('id').primaryKey(),
    manufacturerId: integer('manufacturer_id')
      .notNull()
      .references(() => authorizationManufacturers.id, { onDelete: 'cascade' }),
  ...
  (table) => ({
    manufacturerIdx: uniqueIndex('authorization_qualifications_manufacturer_idx').on(
...
export const authorizationSupportingDocs = pgTable(
  'authorization_supporting_docs',
  {
    id: serial('id').primaryKey(),
    manufacturerId: integer('manufacturer_id')
      .notNull()
    ...
    authorizationLetterFileId: integer('authorization_letter_file_id').references(() => files.id, {
      onDelete: 'set null',
    }),

    // 供货证明
    supplyProof: text('supply_proof'),
    supplyProofFileId: integer('supply_proof_file_id').references(() => files.id, {
      onDelete: 'set null',
    }),
    ...
    serviceCommitmentFileId: integer('service_commitment_file_id').references(() => files.id, {
      onDelete: 'set null',
    }),
  ...
  (table) => ({
    manufacturerIdx: uniqueIndex('authorization_supporting_docs_manufacturer_idx').on(
      table.manufacturerId
    ),
  })
);
...
export const authorizationDeliveries = pgTable(
  'authorization_deliveries',
  {
    ...
    // 追溯记录附件
    logisticsVoucherFileId: integer('logistics_voucher_file_id').references(() => files.id, {
      onDelete: 'set null',
    }),
    receiptVoucherFileId: integer('receipt_voucher_file_id').references(() => files.id, {
      onDelete: 'set null',
    }),
...
export const authorizationReviews = pgTable(
  ...
  (table) => ({
    applicationStageIdx: uniqueIndex('authorization_reviews_application_stage_idx').on(
      table.applicationId,
      table.stage
    ),
  })
...
export const authorizationTodos = pgTable(
  'authorization_todos',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
...
export const authorizationApplicationsRelations = relations(
...
export const authorizationManufacturersRelations = relations(
...
export const authorizationQualificationsRelations = relations(
...
export const authorizationSupportingDocsRelations = relations(
...
export const sampleApplications = pgTable(
  'sample_applications',
  {
    id: serial('id').primaryKey(),
    ...
    // 关联授权申请（可选）
    authorizationApplicationId: integer('authorization_application_id').references(
      () => authorizationApplications.id,
      { onDelete: 'set null' }
    ),
...
export const sampleConfigurations = pgTable(
  'sample_configurations',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
      .notNull()
      .references(() => sampleApplications.id, { onDelete: 'cascade' }),

    // 厂家信息
    manufacturerId: integer('manufacturer_id').references(() => authorizationManufacturers.id, {
      onDelete: 'set null',
    }),
    manufacturerName: varchar('manufacturer_name', { length: 200 }).notNull(),
...
export const sampleDisplays = pgTable(
  'sample_displays',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
...
export const sampleReviews = pgTable(
  ...
  (table) => ({
    applicationStageIdx: uniqueIndex('sample_reviews_application_stage_idx').on(
      table.applicationId,
      table.stage
    ),
  })
...
export const sampleTodos = pgTable(
  'sample_todos',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
...
export const priceApplications = pgTable(
  'price_applications',
  {
    id: serial('id').primaryKey(),
...
export const priceApplicationItems = pgTable(
  'price_application_items',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
      .notNull()
      .references(() => priceApplications.id, { onDelete: 'cascade' }),
...
export const priceReviews = pgTable(
  ...
  (table) => ({
    applicationStageIdx: uniqueIndex('price_reviews_application_stage_idx').on(
      table.applicationId,
      table.stage
    ),
  })
...
export const partnerApplications = pgTable(
  'partner_applications',
  {
    ...
    // 友司基础信息
    partnerCompanyId: integer('partner_company_id').references(() => companies.id, {
      onDelete: 'set null',
    }),
    ...
    // 友司确认状态
    partnerConfirmStatus: partnerConfirmStatusEnum('partner_confirm_status')
      .notNull()
      .default('pending'),
...
export const partnerMaterials = pgTable(
  'partner_materials',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
...
export const partnerReviews = pgTable(
  ...
  (table) => ({
    applicationStageIdx: uniqueIndex('partner_reviews_application_stage_idx').on(
      table.applicationId,
      table.stage
    ),
  })
...
export const partnerTodos = pgTable(
  'partner_todos',
  {
    id: serial('id').primaryKey(),
    applicationId: integer('application_id')
...
export const tenderInfos = pgTable(
  'tender_infos',
  {
    id: serial('id').primaryKey(),
...
export const crawlKeywords = pgTable(
  'crawl_keywords',
  {
    id: serial('id').primaryKey(),
...
export const sealConfigs = pgTable(
  'seal_configs',
  {
    id: serial('id').primaryKey(),
...
export const signTasks = pgTable(
  'sign_tasks',
  {
    id: serial('id').primaryKey(),
...
export const signers = pgTable(
  'signers',
  {
    ...
    taskId: integer('task_id')
      .notNull()
      .references(() => signTasks.id, { onDelete: 'cascade' }),
...
export const quoteAnalysisRequests = pgTable(
  'quote_analysis_requests',
  {
    id: serial('id').primaryKey(),
...
export const quoteFactors = pgTable(
  'quote_factors',
  {
    id: serial('id').primaryKey(),
    ...
    requestId: integer('request_id')
      .notNull()
      .references(() => quoteAnalysisRequests.id, { onDelete: 'cascade' }),
...
export const competitorQuotePredictions = pgTable(
  'competitor_quote_predictions',
  {
    id: serial('id').primaryKey(),
...
export const quoteSchemes = pgTable(
  'quote_schemes',
  {
    id: serial('id').primaryKey(),
...
export const quoteHistoryComparisons = pgTable(
  'quote_history_comparisons',
  {
    id: serial('id').primaryKey(),
...
export const competitorQuotePredictionsRelations = relations(
...
export const bidAttendees = pgTable('bid_attendees', {
  ...
  attendanceId: integer('attendance_id')
    .notNull()
    .references(() => bidAttendances.id, { onDelete: 'cascade' }),
...
export const bidNotificationCollectionsRelations = relations(
...
export type NotificationCollectionStatus =
  (typeof notificationCollectionStatusEnum.enumValues)[number];
...
export * from './schema/tender-center';
...
export const tenderAlerts = pgTable(
  'tender_alerts',
  {
    id: serial('id').primaryKey(),

    // 关联信息
    tenderInfoId: integer('tender_info_id')
      .notNull()
      .references(() => tenderInfos.id, { onDelete: 'cascade' }),
    subscriptionId: integer('subscription_id').references(() => tenderSubscriptions.id, {
      onDelete: 'set null',
    }),
    userId: integer('user_id')
      .notNull()
...
export const imageGenerations = pgTable(
  ...
  (table) => ({
    ...
    businessObjectIdx: index('image_generations_business_object_idx').on(
